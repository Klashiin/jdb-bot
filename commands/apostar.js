...
module.exports = {
  ...
  async execute(client, message, args, Discord, profileData) {
    ...
    let randomNumbers = [];
    for (i = 0; i < 5; i++) {
      randomNumbers[i] = getRandomInt(1000, 9999);
      let dezena = randomNumbers[i].toString().substr(-2);
      console.log(randomNumber);
      console.log(dezena);
      // Definir bichosSorteados baseado na dezena:
      if (dezena >= 01 && dezena <= 04) {
        bichosSorteados[i] = "avestruz";
        imagem =
    ...
    // Comparar bichoSorteado com bicho e aumentar pontos e wins caso vencer:
